...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime79.jsxs)(import_jsx_runtime78.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react69.cloneElement)(children, triggerProps), (0, import_jsx_runtime77.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React80.forwardRef(({
    children,
    ...props
...
var Toast = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime103.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime103.jsx)(Transition2, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
